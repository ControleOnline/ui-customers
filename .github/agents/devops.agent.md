---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-customers, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-customers`.
...
- Checkout local: `app-community/modules/controleonline/ui-customers`
